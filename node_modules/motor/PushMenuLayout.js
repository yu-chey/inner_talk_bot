...
var _armyKnifeCallAfter = require('army-knife/callAfter');

var _armyKnifeCallAfter2 = _interopRequireDefault(_armyKnifeCallAfter);
...
var PushMenuLayout = (function (_Molecule) {
    ...
    function PushMenuLayout(initialOptions) {
        ...
        _get(Object.getPrototypeOf(PushMenuLayout.prototype), 'constructor', this).call(this, initialOptions);
    ...
    _createClass(PushMenuLayout, [{
        ...
        value: function _createComponents() {
            ...
            this.touchSync = new _famousInputsGenericSync2['default'](['touch']);

            this.alignment = this.options.menuSide == "left" ? 0 : 1;
            this.animationTransition = new _famousTransitionsTransitionable2['default'](0);
        ...
        value: function _animate(targetState, callback) {
            ...
            function setupCallback(numberOfTransitions) {
                ...
                _callback = (0, _armyKnifeCallAfter2['default'])(numberOfTransitions, (function () {
            ...
            setupCallback(1);
            if (targetState == 'open') {
                this.animationTransition.set(1, { duration: this.options.animationDuration, curve: _famousTransitionsEasing2['default'].outExpo }, _callback);
            } else if (targetState == 'close') {
                this.animationTransition.set(0, { duration: this.options.animationDuration, curve: _famousTransitionsEasing2['default'].outExpo }, _callback);
            }
        }
        ...
        value: function render() {
            ...
            if (this.options.blur && this.options.fade && this.options.animationType == 'moveBack') {
                ...
                // statement above.
                if (this.contentMol._child[1].get() instanceof _famousCoreSurface2['default']) {
            ...
            return _get(Object.getPrototypeOf(PushMenuLayout.prototype), 'render', this).call(this);
        }
    }]);
